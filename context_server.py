#!/usr/bin/env python3
"""
Wrapper script for MCP Context Server.

This script provides a proper entry point for running the MCP Context Server
...
try:
    from context_server.cli import main as cli_main
    from context_server.config import Config
    from context_server.server import main as server_main
except ImportError as e:
    print(f"Error importing context_server modules: {e}")
    print(
...
def run_server():
    ...
    print("Starting MCP Context Server...")
...
def show_help():
    ...
    print("MCP Context Server Wrapper")
    print("=" * 40)
    print()
    print("Usage:")
    print("  python context_server.py          - Start the MCP server")
    print("  python context_server.py --health - Run health check")
    print("  python context_server.py --help   - Show this help")
    print()
    ...
    print()
    print("For more CLI options, use the context_server module directly:")
    print("  python -m context_server.cli --help")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        if arg in ["-h", "--help"]:
            ...
            sys.argv = ["context_server.cli", "--health"]
            cli_main()
        else:
