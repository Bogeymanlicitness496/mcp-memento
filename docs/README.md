...
### Enhanced SQLite Features
- **Improved performance** - Optimized queries for faster memory retrieval
- **Better error handling** - More descriptive error messages and recovery
- **Simplified setup** - Zero configuration required for local use
...
See [temporal-memory.md](docs/temporal-memory.md) for comprehensive temporal tracking guide.
...
- **Universal export/import** - Backup and restore your memories
- **Progress reporting** - Track long-running operations
- **Format v2.0** - Enhanced metadata with version info and counts

### Architecture Improvements
- **Thread-safe operations** - Safe for concurrent access
- **Better error handling** - Improved error messages and recovery
- **Dry-run mode** - Test export/import operations without writing data
...
# Test import first
memorygraph import --format json --input backup.json --dry-run
```
...
- **SQLite backend** - Simple, local storage with zero dependencies
- 1,200+ tests passing
