"""
Error handling utilities for Context Keeper.
...
def handle_errors(
    ...
    This decorator wraps common exceptions into Context Keeper-specific exception types,
    ...
    def decorator(func: F) -> F:
        ...
        async def async_wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            try:
                ...
                # Re-raise Context Keeper exceptions as-is
                raise
