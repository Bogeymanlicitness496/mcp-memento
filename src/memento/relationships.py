...
class RelationshipManager:
    ...
    def get_types_by_category(
        self, category: RelationshipCategory
        ...
        return [
            rel_type
            for rel_type, meta in self.metadata.items()
    ...
    def create_relationship_properties(
        ...
        **kwargs,
        ...
        return RelationshipProperties(
            ...
            else metadata.default_confidence,
            context=context,
            **kwargs,
        )
    ...
    def reinforce_relationship_properties(
        ...
        new_success_rate = (
            new_validation / total_evidence if total_evidence > 0 else None
        )
    ...
    def find_contradictory_relationships(
        ...
        for i, rel1 in enumerate(relationships):
            for rel2 in relationships[i + 1 :]:
                ...
                if (
                    rel1.from_memory_id == rel2.from_memory_id
                    and rel1.to_memory_id == rel2.to_memory_id
                ):
    ...
    def suggest_relationship_type(
        self, from_memory: Memory, to_memory: Memory, context: Optional[str] = None
        ...
        if (
            ...
            and to_memory.type.value == "technology"
        ):
        ...
        if (
            from_memory.type.value == "code_pattern"
            and to_memory.type.value == "code_pattern"
        ):
